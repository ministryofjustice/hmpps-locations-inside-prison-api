...
INSERT INTO certification (certified, certified_normal_accommodation) VALUES (true, 1);
...
INSERT INTO location (prison_id, path_hierarchy, code, location_type, location_type_discriminator, parent_id, accommodation_type, residential_housing_type, deactivated_by, planet_fm_reference, proposed_reactivation_date, deactivated_reason, deactivated_date, status, when_created, when_updated, updated_by)
values ('MDI', 'A-2-001', '001', 'CELL', 'CELL', (select id from location where prison_id = 'MDI' and path_hierarchy = 'A-2'), 'NORMAL_ACCOMMODATION', 'NORMAL_ACCOMMODATION', 'LOCATION_RO', 'FT9232/1', current_date + interval '100 days', 'MAINTENANCE', now(), 'INACTIVE',  now(), now(), 'LOCATION_RO');
...
INSERT INTO location (prison_id, path_hierarchy, code, location_type, location_type_discriminator, parent_id, accommodation_type, residential_housing_type, deactivated_by, planet_fm_reference, proposed_reactivation_date, deactivated_reason, deactivation_reason_description, deactivated_date, status, when_created, when_updated, updated_by)
values ('MDI', 'A-2-002', '002', 'CELL', 'CELL', (select id from location where prison_id = 'MDI' and path_hierarchy = 'A-2'), 'NORMAL_ACCOMMODATION', 'NORMAL_ACCOMMODATION', 'LOCATION_RO', 'FT9232/1', current_date + interval '100 days', 'MAINTENANCE', 'More info', now(), 'INACTIVE',  now(), now(), 'LOCATION_RO');
INSERT INTO capacity (max_capacity, working_capacity) VALUES (2,1);
INSERT INTO certification (certified, certified_normal_accommodation) VALUES (true, 1);
...
INSERT INTO location (prison_id, path_hierarchy, code, location_type, location_type_discriminator, parent_id, accommodation_type, residential_housing_type, deactivated_by, planet_fm_reference, proposed_reactivation_date, deactivated_reason, deactivation_reason_description, deactivated_date, status, when_created, when_updated, updated_by)
values ('MDI', 'A-2-003', '003', 'CELL', 'CELL', (select id from location where prison_id = 'MDI' and path_hierarchy = 'A-2'), 'NORMAL_ACCOMMODATION', 'NORMAL_ACCOMMODATION', 'LOCATION_RO', 'FT9232/1', current_date + interval '100 days', 'OTHER', 'Does not exist', now(), 'INACTIVE',  now(), now(), 'LOCATION_RO');
INSERT INTO capacity (max_capacity, working_capacity) VALUES (2,1);
INSERT INTO certification (certified, certified_normal_accommodation) VALUES (true, 1);
