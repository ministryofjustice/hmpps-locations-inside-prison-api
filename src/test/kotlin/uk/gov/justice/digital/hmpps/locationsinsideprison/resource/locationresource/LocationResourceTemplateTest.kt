...
const val EXPECTED_USERNAME_TEMPLATE = "A_TEST_USER"

@WithMockAuthUser(username = EXPECTED_USERNAME_TEMPLATE)
class LocationResourceTemplateTest : SqsIntegrationTestBase() {
