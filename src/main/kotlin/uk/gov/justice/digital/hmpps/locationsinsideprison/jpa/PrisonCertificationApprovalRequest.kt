...
@Entity
@DiscriminatorFormula("CASE WHEN approvalType = 'SIGNED_OP_CAP' THEN 'PRISON_APPROVAL_REQUEST' ELSE 'LOCATION_APPROVAL_REQUEST' END")
@DiscriminatorValue("PRISON_APPROVAL_REQUEST")
@Table(name = "certification_approval_request")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
open class PrisonCertificationApprovalRequest(
  @Id
  @GeneratedUuidV7
  ...
  protected val approvalType: ApprovalType,

  @Column(nullable = false)
  protected val prisonId: String,
