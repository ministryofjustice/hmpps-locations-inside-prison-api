...
data class Location(
  ...
  @param:Schema(description = "Indicates that a location above this one has a pending approval", example = "true", required = false)
  val locationAbovePendingApproval: Boolean? = null,
  ...
  @param:Schema(description = "The current pending approval request for this location", example = "57818979-573c-433a-9e51-2d83f087c11c", required = false)
