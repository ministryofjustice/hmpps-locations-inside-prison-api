...
enum class TransactionType(val description: String) {
  LOCATION_CREATE("Created residential location"),
  LOCATION_CREATE_NON_RESI("Created non-residential location"),
  LOCATION_UPDATE("Updated residential location"),
  LOCATION_UPDATE_NON_RESI("Updated non-residential location"),
  SYNC("NOMIS sync (Residential)"),
  SYNC_NON_RESIDENTIAL("NOMIS sync (Non-Residential)"),
  DELETE("Locations deleted"),
  CAPACITY_CHANGE("Capacity change"),
  CELL_TYPE_CHANGES("Cell type change"),
  DEACTIVATION("Deactivation"),
  PERMANENT_DEACTIVATION("Permanent deactivation"),
  REACTIVATION("Reactivation"),
  CELL_CONVERTION_TO_ROOM("Cell conversion to room"),
  ROOM_CONVERTION_TO_CELL("Room conversion to cell"),
  SIGNED_OP_CAP("Signed operational capacity"),
  RESI_SERVICE_ACTIVATION("Residential service activation"),
  NON_RESI_SERVICE_ACTIVATION("Non-residential service activation"),
  INCLUDE_SEG_IN_ROLL_COUNT_ACTIVATION("Include segregation in roll count activation"),
  APPROVAL_PROCESS_ACTIVATION("Certification approval activation"),
  REQUEST_CERTIFICATION_APPROVAL("Request certification approval"),
  APPROVE_CERTIFICATION_REQUEST("Approve request"),
